...
class TareasControllerTest < ActionController::TestCase
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post :create, tarea: { descripcion: @tarea.descripcion, elemento_id: @tarea.elemento_id, estado_tarea_id: @tarea.estado_tarea_id, nombre: @tarea.nombre }
    end
  ...
  test "should update tarea" do
    patch :update, id: @tarea, tarea: { descripcion: @tarea.descripcion, elemento_id: @tarea.elemento_id, estado_tarea_id: @tarea.estado_tarea_id, nombre: @tarea.nombre }
    assert_redirected_to tarea_path(assigns(:tarea))
  end

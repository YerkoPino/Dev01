...
class TemasControllerTest < ActionController::TestCase
  ...
  test "should create tema" do
    assert_difference('Tema.count') do
      post :create, tema: { acta_reunion_id: @tema.acta_reunion_id, descripcion: @tema.descripcion, estado: @tema.estado, nombre: @tema.nombre }
    end
  ...
  test "should update tema" do
    patch :update, id: @tema, tema: { acta_reunion_id: @tema.acta_reunion_id, descripcion: @tema.descripcion, estado: @tema.estado, nombre: @tema.nombre }
    assert_redirected_to tema_path(assigns(:tema))
  end
